...
2. 將 Blog_Project 整個專案下載下來
![image] (https://github.com/toppy368/Blog_Project/blob/master/Readme_image/Download.png)  
有兩種下載方法，第一種是按下**Download zip**按鈕、第二種是按下**Clone in Disktop**(**需安裝Github客戶端軟體**)  
...
##各檔案功能說明
這個專案目前為止將分為四大功能，分別為**首頁**、**帳號**、**後台**、**文章**、**資料庫**五大區域，其中**首頁與帳號**都在專案資料夾的**根目錄**中、**後臺及文章**放在**admin資料夾**中  

以下將顯示每個功能所包含的檔案名稱、用途及目前進度，目前已知的BUG會顯示在"近況顯示"上，資料夾也會隨者開發過程的需要而有所變動或更新，當有檔案結構變動時，也會在以下內容中註明清楚  

**最後更新日期：2015/6/1 22:46**  
